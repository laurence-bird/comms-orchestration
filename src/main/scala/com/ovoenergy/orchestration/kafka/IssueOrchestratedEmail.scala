...
import com.ovoenergy.orchestration.domain.customer.EmailAddress
import org.apache.kafka.clients.producer.RecordMetadata

import scala.concurrent.Future

class IssueOrchestratedEmail(sendEvent: OrchestratedEmailV3 => Future[RecordMetadata]) extends IssueOrchestratedComm[EmailAddress] {

  def send(customerProfile: Option[CustomerProfile], emailAddress: EmailAddress, triggered: TriggeredV3): Future[RecordMetadata] = {
